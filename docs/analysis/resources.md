...
Medios, herramientas o documentos que se usan para realizar los procesos del
caso de estudio.
...
- Cuaderno o libreta de ventas.
- Planilla Excel de productos y precios.
- Mensajes de WhatsApp con clientes y proveedores.
- Facturas o recibos de venta.
- Facturas de compra de proveedores.
- Notas de ingreso y salida de almacen.
- Fotografias o codigos de repuestos.
- Listas impresas de precios y stock.
- Formularios o comprobantes de cambios, devoluciones y garantias.
